...
namespace FST{
	...
	void FST::createFst(){
		for (int i = 0; i < NUMBER_OF_GRAPHS; i++){
			...
			case 9:		this[i] = *(new FST(NULL_STR, GRAPH_CLOSE_PARENTHESIS));	break;
			case 10:	this[i] = *(new FST(NULL_STR, GRAPH_OPEN_SQBRACE));			break;
			case 11:	this[i] = *(new FST(NULL_STR, GRAPH_CLOSE_SQBRACE));		break;
			case 12:	this[i] = *(new FST(NULL_STR, GRAPH_OPERATIONS));			break;
			case 13:	this[i] = *(new FST(NULL_STR, GRAPH_CONDITION));			break;
			case 14:	this[i] = *(new FST(NULL_STR, GRAPH_FUNCTION));				break;
