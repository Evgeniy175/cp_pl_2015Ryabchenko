...
namespace FST{
	...
	void FST::createFst(){
		for (int i = 0; i < NUMBER_OF_GRAPHS; i++){
			...
			case 5:		this[i] = *(new FST(NULL_STR, GRAPH_OPEN_BRACE));			break;
			case 6:		this[i] = *(new FST(NULL_STR, GRAPH_CLOSE_BRACE));			break;
			case 7:		this[i] = *(new FST(NULL_STR, GRAPH_OPEN_PARENTHESIS));		break;
			case 8:		this[i] = *(new FST(NULL_STR, GRAPH_CLOSE_PARENTHESIS));	break;
			case 9:		this[i] = *(new FST(NULL_STR, GRAPH_OPEN_SQBRACE));			break;
			case 10:	this[i] = *(new FST(NULL_STR, GRAPH_CLOSE_SQBRACE));		break;
			...
			case 14:	this[i] = *(new FST(NULL_STR, GRAPH_RETURN));				break;
			case 15:	this[i] = *(new FST(NULL_STR, GRAPH_BEGIN));				break;
			case 16:	this[i] = *(new FST(NULL_STR, GRAPH_ID));					break;
			case 17:	this[i] = *(new FST(NULL_STR, GRAPH_LITERAL_STRING));		break;
			case 18:	this[i] = *(new FST(NULL_STR, GRAPH_LITERAL_NUMBER));		break;
			default:	break;
			};
		};
	};
